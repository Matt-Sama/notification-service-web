<template>
  <div class="main-contain">
        ...
        <el-card>
          <div class="option-header">
            <div class="keyword-wrapper">
              ...
              <el-input size="small" placeholder="可输入敏感词等关键字查询"></el-input>
            </div>
            <div class="date-time">
      ...
      <div class="table-wrapper">
        <el-card>
          ...
          <el-tab-pane label="全部">
            <sensitive-word-table></sensitive-word-table>
          </el-tab-pane>
    ...
    <el-drawer
          ...
          direction="rtl"
        >
        <sensitive-word-drawer></sensitive-word-drawer>
    </el-drawer>
  </div>
</template>
...
import SensitiveWordTable from './components/sensitiveWordTable'
import SensitiveWordDrawer from './components/sensitiveWordDrawer'
export default {
